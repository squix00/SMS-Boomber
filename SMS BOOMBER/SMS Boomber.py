...
Made By: Squix
	...
	numara = input("Telefon numarasını (5xx)-xxx-xx-xx Bu formatta giriniz : ")
	delay = int(input("Bekleme süresini giriniz (Tavsiye Edilen 5): "))
	adet = int(input("Kaç adet sms göndermek istiyorsun: "))
	tc = str(input("Tc girin veya r tuşuna basın: "))
	...
	if tc == "r" or tc == "R":
		tc = tcolustur()
		print(numara+" Numarası için T.C numaranız: "+tc+" Numaraya ilk defa sms gönderiyorsanız not edin")
		print("")
	else:
		tc = tc
	headers = {
	...
	while i<=adet:
		...
		if kod == "200":
			print(str(i)+". Gönderildi!")
		else:
			print("Hata Oldu Kod: "+kod)
		time.sleep(delay)
		i=i+1
